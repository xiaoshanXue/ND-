<template>
	<view style="height: 100vh;" :class="nightStatus?'nightTheme':''">
		...
		<view class="flex align-center justify-center">
			<image :src="CurCover" lazy-load mode="aspectFill"
				style="border-radius: 35rpx;box-shadow: 0 2rpx 6rpx 0;width: 600rpx;height: 380rpx;"></image>
		</view>
					...
					<view class="flex align-center font px-2" style="height: 85rpx;" hover-class="bg-light"
						...
						<view class="flex-1 ml-3 flex align-center">
							<template v-if="item.playStatus">
								...
								<my-icon :iconId="item.playStatus === 1?'icon-bofangzhong2':'icon-bofangsanjiaoxing'"
									iconSize="35"></my-icon>
							</template>
						</view>
					</view>
		...
		<!-- 歌手简介详情 -->
		<uni-popup ref="popup">
			<view class="px-2 shadow" style="width: 600rpx;height: 850rpx;border-radius: 40rpx;"
